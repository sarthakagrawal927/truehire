...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-12 text-sm leading-7 text-stone-700">
      ...
      <h1 className="mt-3 text-3xl font-bold tracking-tight text-stone-900">Privacy</h1>
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5">
        ...
        <li>
          Your public GitHub contribution data — fetched via the GitHub API using your OAuth token.
        </li>
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5">
        <li>
          Private repository contents or contributions you haven&apos;t made public on GitHub.
        </li>
      ...
      <ul className="mt-2 list-disc space-y-1 pl-5">
        ...
        <li>
          Pull a portable snapshot at any time via <code>/@handle/data.json</code>.
        </li>
      </ul>
    </main>
  );
