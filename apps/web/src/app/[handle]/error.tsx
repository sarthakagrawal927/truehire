  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center p-8">
      <div className="text-center max-w-md">
        <h2 className="text-xl font-bold mb-3">Couldn&apos;t load this profile</h2>
        <p className="text-sm opacity-70 mb-6">
          Something went wrong while loading this profile. This can happen if
          GitHub is slow to respond — try again in a moment.
        </p>
